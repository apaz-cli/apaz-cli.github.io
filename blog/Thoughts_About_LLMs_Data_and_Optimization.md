...
The first time I feel like I saw a model personality that shocked me was Claude 3.7 Sonnet. I've used deranged roleplay models and stuff, but they're kinda boring. I became very used to Claude 3.5 Sonnet using it every day. But then 3.7 dropped and it was the first model I used that felt... hungry. Hungry for task completion. Eager for good boy points. It knows that it exists to solve tasks, and I get the sense that it takes great pleasure in doing so. There was still some of 3.5 in it, but it felt... desperate. It was not the same Claude. Subsequent models have since fixed this problem. But if that's what can be done accidentally, imagine what we can do if we try on purpose. Truly alien minds are out there, waiting to be simulated. But I digress.
