...
# The Open Source Contributor Competition
...
#### Open source maintainers compete for contributors. How can you win?
...
    No language is "better" than another. Usually these comparisons are an exercise 
in tribalism. But bear with me here. Let's look at just the technology. In a vacuum, 
Julia seems overwhelmingly "better" than Python. It's a complex and incredible 
marvel of engineering. It has everything going for it, from a technical perspective. 
Why, then, does Julia not attract any new contributors? Surely all of that should 
make people want to work on it, right?
...
    Yeah, no. None of that matters. We don't live in a vaccum. You can have the 
fanciest compiler in the world. Nobody cares.

    Developer experience matters. More than enough to sink an entire project.
...
just find some other project. Unless you can find a select few rare and 
ideologically motivated individuals, the only way to get contributors who will 
sacrifice for your cause is to pay them. Nobody wants to clean up your mess for you. 
Open sourcing your code is not going to change that. Nobody is going to materialize 
next to you with a solution.
...
    They forget that non-ideologues have their own problems to deal with.
...
    This requires a paradigm shift. For an open source contributor, the decision to 
contribute or not is a simple risk vs reward. The risk is wasted time. The reward is 
getting features and fixes merged. In this way, it's a lot like a startup product. 
The more annoying the experience, the more users and contributors will churn. But 
get it right, and you could experience explosive growth.
...
    In addition to lowering the barrier to entry, You need to make sure people know 
it's low. Otherwise they may make a subconscious error in their risk/reward analysis 
and not contribute, to the detriment of all parties. Advertising good developer 
experience is helpful in advertising the project, but even more helpful for the 
maintinence of the project.
...
1. Automated testing is a must. Write good, exhaustive tests that don't flake so 
that contributors can be confident that their features and fixes won't cause 
regressions elsewhere. Prioritize integration tests. Equally important, write up a 
guide on how to add tests and run them, and place it somewhere prominent. Both 
processes should be as frictionless as possible.
...
time as an investment. If people see discussions about features and PR, they know 
...
9. Maintain a high bar for quality.

<br>

## Conclusion

TLDR, empower your contributors.

Identify potential roadblocks and rip them out before
they become a problem.
things that might be holding them back. 
Remove roadblocks.
